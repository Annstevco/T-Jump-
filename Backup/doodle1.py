...
class DoodleJump:
    def __init__(self, score=0, direction=1, playerx=400, playery=400, jump=0, gravity=0, xmovement=0, cameray=0):
...
#Child Class 
class Player(DoodleJump):
    def __init__(self,core=0, direction=1, playerx=400, playery=400, jump=0, gravity=0, xmovement=0, cameray=0):
        super().__init__(self.direction, self.xmovement, self.player, self.playerx, self.playery, self.cameray, self.gravity, self.jump)
